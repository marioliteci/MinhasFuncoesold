...
class Pacotes_PHP {
    ...
    const key = 'AKIA3GKU26MRGNGQ6ZFR';
    const secret = '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';
    const bucket = '07840348000136';
    const bucket_documentos = '07840348000136documentos';
    const bucket_pix = '07840348000136pix';
    const buckettmp = '07840348000136tmp';
    const key_sms = 'AKIA3GKU26MRNB23H2N3';
    const key_sms_secret = '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';
    const bucket_qrcodeimg_pix = '07840348000136qrcodeimgpix';
